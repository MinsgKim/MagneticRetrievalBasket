...
% optimizing boundaries
lb = [repmat(5e03, 1, num_links), [pi/3, repmat(-pi, 1, num_links-1)]];
ub = [repmat(6e04, 1, num_links), [pi/2, repmat(pi, 1, num_links-1)]];
...
% T = RS.Get_Tau(num_links, link_length, M_opt, x_opt(num_links+1:end), r_ext, k_spring, em2);
