...
MagneticBasket_Simscape_Optimizer_dda62cd9_1_NeDaePrivateData_create (
NeDaePrivateData * smData ) ; void
MagneticBasket_Simscape_Optimizer_dda62cd9_1_dae ( NeDae * * dae , const
...
MagneticBasket_Simscape_Optimizer_dda62cd9_1_NeDaePrivateData_create ( smData
