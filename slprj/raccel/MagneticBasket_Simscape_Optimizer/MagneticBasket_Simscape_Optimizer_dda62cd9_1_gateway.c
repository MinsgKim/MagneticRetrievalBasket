...
#endif
#include "nesl_rtw.h"
#include "MagneticBasket_Simscape_Optimizer_dda62cd9_1.h"
#include "MagneticBasket_Simscape_Optimizer_dda62cd9_1_gateway.h"
void MagneticBasket_Simscape_Optimizer_dda62cd9_1_gateway ( void ) {
NeModelParameters modelparams = { ( NeSolverType ) 0 , 0.001 , 0.001 , 0.001
, 1 , 0 , ( NeModifyAbsTol ) 2 , 0.001 , 0 , 0 , 0 , 0 , ( SscLoggingSetting
) 0 , 661247773 , 0 , 0 , 0 , } ; NeSolverParameters solverparams = { 0 , 0 ,
1 , 0 , 0 , 0.001 , 0.001 , 1e-09 , 0 , 0 , 100 , 0 , 1 , (
...
NePartitionStorageMethod ) 0 , 1024 , ( NePartitionMethod ) 0 , 0 , (
...
= NULL ; int rtwLogDaes [ 1 ] = { 0 } ; int * solverHitDaes = NULL ; { static
...
MagneticBasket_Simscape_Optimizer_dda62cd9_1_dae ( & dae , & modelparams , &
solverparams ) ; nesl_register_simulator_group (
"MagneticBasket_Simscape_Optimizer/Solver Configuration_1" , 1 , & dae , &
solverparams , & modelparams , numOutputs , outputparameters , 0 , rtpDaes ,
1 , rtwLogDaes , 0 , solverHitDaes ) ; }
