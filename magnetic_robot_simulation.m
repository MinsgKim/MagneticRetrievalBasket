classdef magnetic_robot_simulation
    ...
    methods
        ...
        function cost = objective_function(obj, x, num_links)
            ...
            [T_actual, theta_actual] = obj.RK.simulate_robot_transform(num_links, M, theta_M, r, link_length, obj.EM);
...
%             cost = -theta_actual(1);
        ...
        function [c, ceq] = nonlcon_position_constraints(obj, x, num_links)
            ...
            for p=1:7
                ...
                theta_actual_rest = theta_actual_rest + theta_actual(p);
...
%--------------------quasi-static equilibrium equation----------------------
        ...
        function cost = objective_static(obj, x, num_links, link_length, cross_section_area, r_ext, k_spring, EM)
            ...
            for p = 1:num_links
                ...
                theta_cal = theta_cal + theta_eq(p);
                Ly_sum = Ly_sum + link_length * cos(theta_cal);
...
%             cost = -theta_eq(1);
%             cost = -(x_sum + y_sum) + gamma * x_end^2;
            cost = (0.011 - Ly_sum)^2;
        ...
        function [c, ceq] = constraint_static(obj, x, num_links, link_length, cross_section_area, r_ext, k_spring, EM)
            ...
            for p = 1:num_links
                ...
                theta_cal = theta_cal + theta_eq(p);
                Lx_sum = Lx_sum + link_length * cos(theta_cal);
